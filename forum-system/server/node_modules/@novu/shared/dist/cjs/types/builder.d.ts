export declare enum FieldOperatorEnum {
    ALL_IN = "ALL_IN",
    ANY_IN = "ANY_IN",
    BETWEEN = "BETWEEN",
    EQUAL = "EQUAL",
...
export declare enum FieldLogicalOperatorEnum {
    AND = "AND",
    OR = "OR"
}
...
export type BuilderFieldOperator = FieldOperatorEnum.LARGER | FieldOperatorEnum.SMALLER | FieldOperatorEnum.LARGER_EQUAL | FieldOperatorEnum.SMALLER_EQUAL | FieldOperatorEnum.EQUAL | FieldOperatorEnum.NOT_EQUAL | FieldOperatorEnum.ALL_IN | FieldOperatorEnum.ANY_IN | FieldOperatorEnum.NOT_IN | FieldOperatorEnum.BETWEEN | FieldOperatorEnum.NOT_BETWEEN | FieldOperatorEnum.LIKE | FieldOperatorEnum.NOT_LIKE | FieldOperatorEnum.IN | FieldOperatorEnum.IS_DEFINED;
...
export type FilterParts = IFieldFilterPart | IWebhookFilterPart | IRealtimeOnlineFilterPart | IOnlineInLastFilterPart | IPreviousStepFilterPart | ITenantFilterPart;
