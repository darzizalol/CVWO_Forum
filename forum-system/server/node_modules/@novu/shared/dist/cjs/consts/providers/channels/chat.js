...
exports.chatProviders = [
    {
        id: types_1.ChatProviderIdEnum.Slack,
        displayName: 'Slack',
    ...
    {
        id: types_1.ChatProviderIdEnum.Discord,
        displayName: 'Discord',
        channel: types_1.ChannelTypeEnum.CHAT,
        credentials: [],
    ...
    {
        id: types_1.ChatProviderIdEnum.GrafanaOnCall,
    ...
    {
        id: types_1.ChatProviderIdEnum.MsTeams,
        displayName: 'MSTeams',
        channel: types_1.ChannelTypeEnum.CHAT,
        credentials: [],
    ...
    {
        id: types_1.ChatProviderIdEnum.Mattermost,
    ...
    {
        id: types_1.ChatProviderIdEnum.Ryver,
        displayName: 'Ryver',
        channel: types_1.ChannelTypeEnum.CHAT,
        credentials: [],
    ...
    {
        id: types_1.ChatProviderIdEnum.Zulip,
        displayName: 'Zulip',
        channel: types_1.ChannelTypeEnum.CHAT,
        credentials: [],
    ...
    {
        id: types_1.ChatProviderIdEnum.GetStream,
    ...
    {
        id: types_1.ChatProviderIdEnum.RocketChat,
    ...
    {
        id: types_1.ChatProviderIdEnum.WhatsAppBusiness,
